...
//
///**
// *  http://www.throwable.club/2019/05/05/spring-cloud-gateway-custom-global-filter/
// */
//@Slf4j
//@Component
...
//            accessRecord.setQueryParams(queryParams);
//            try {
...
//            accessRecord.setBody(builder.toString());
//
...
//    }
//
//    private Mono<Void> returnMono(ServerWebExchange exchange, GatewayFilterChain chain, AccessRecord accessRecord) {
//        return chain.filter(exchange).then(Mono.fromRunnable(() -> {
//            Long startTime = exchange.getAttribute("startTime");
//            if (startTime != null){
//                long executeTime = (System.currentTimeMillis() - startTime);
//                accessRecord.setExpendTime(executeTime);
//                accessRecord.setResponseCode(Objects.requireNonNull(exchange.getResponse().getStatusCode()).value());
//                // TODO 异步日志
//                writeAccessLog(accessRecord);
//            }
//        }));
